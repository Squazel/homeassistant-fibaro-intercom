...
async def test_intercom_connection():
    ...
    PORT = int(os.getenv("FIBARO_PORT", "8081"))
    ...
    if HOST == "YOUR_INTERCOM_IP" or USERNAME == "YOUR_USERNAME" or PASSWORD == "YOUR_PASSWORD":
        ...
        print("   FIBARO_PORT=8081 (optional, defaults to 8081)")
        print("\n   Example (PowerShell):")
    ...
    try:
        ...
        async with websockets.connect(uri, ssl=ssl_context, ping_timeout=10) as websocket:
...
if __name__ == "__main__":
    ...
    print("   Environment variables: FIBARO_HOST, FIBARO_USERNAME, FIBARO_PASSWORD, FIBARO_PORT")
    print("")
